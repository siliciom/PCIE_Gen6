...
function void connect_phase(uvm_phase phase);
    ...
    if(pcie_ecfg.has_rc_top_agent)
        begin
           ...
           rc_top_agent.rc_controller_agent.rc_controller_monitor.ep_pl_model = ep_top_agent.ep_controller_agent.ep_pl_model;
      ...
      begin
          ...
          rc_top_agent.rc_controller_agent.rc_controller_monitor.rc_mon_ap_dl.connect(pcie_scoreboard.rc_con_dl_imp);
          ep_top_agent.ep_controller_agent.ep_controller_monitor.ep_ap_mon_dl.connect(pcie_scoreboard.ep_con_dl_imp);
               end
