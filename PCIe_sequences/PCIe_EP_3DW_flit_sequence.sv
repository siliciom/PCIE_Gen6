//=========================================================================================
// File         : PCIe_EP_3DW_flit_sequence.sv
// Project      : PCIE_Gen6
// Description  : PCIe_sequences/PCIe_EP_3DW_flit_sequence.sv
// Author       : 
// Date         : 2026-08-20
//=========================================================================================
 ...
 * you agree to and are bound to the terms of the SILICIOM TECHNOLOGIES PVT LTD license agreement.
...
class PCIe_EP_3DW_flit_sequence extends PCIe_EP_controller_base_sequence;

  `uvm_object_utils(PCIe_EP_3DW_flit_sequence)

  bit [31:0] mem_addr_32 = 32'h0000_2000;
  bit [31:0] wr_data; // = 32'hA5A5_1234;

  function new(string name = "PCIe_EP_3DW_flit_sequence");
    super.new(name);
  endfunction
  ...
  task body();
    ...
    `uvm_info("TL_EP_3DW", "Sending 3DW MWr", UVM_LOW)
    pcie_seq_item.print();
    ...
    //        })
    //      `uvm_error("EP_3DW", "randomize failed for 3DW MRd readback")
    //
    //    `uvm_info("TL_EP_3DW", "Readback 3DW MRd", UVM_LOW)
    //    pcie_seq_item.print();
    //    finish_item(pcie_seq_item);
    //
    //    `uvm_info("EP_3DW", "EXIT_FROM_EP_3DW_SEQUENCE_BODY", UVM_LOW)
