//=========================================================================================
// File         : PCIe_PIPE_interface.sv
// Project      : PCIE_Gen6
// Description  : PCIe_top\PCIe_PIPE_interface.sv
// Author       : 
// Date         : 2026-08-17
//=========================================================================================
...
interface PCIe_RC_interface(input logic pclk);
...
interface PCIe_EP_interface(input logic pclk);
