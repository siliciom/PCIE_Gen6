    ...
    task rx_sipo(virtual PCIe_EP_PHY_interface ep_phy_intf_rx);
      ...
      `uvm_info("EP_PHY_MONITOR","ENTERED_INTO_RX_SIPO_EP_MONITOR", UVM_LOW)
         ...
         begin
          ...
          pcie_seq_item.data_q_ep_mon.push_back(rx_data);
         `uvm_info("EP_PHY_MONITOR",$sformatf("RX_32_BIT_PARALLEL_EP_MONITOR_DATA = %08h EP_MONITOR_QUEUE_SIZE=%d", rx_data,pcie_seq_item.data_q_ep_mon.size()),UVM_LOW);
