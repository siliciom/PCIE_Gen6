    ...
    task tx_sipo(virtual PCIe_RC_PHY_interface rc_phy_intf_tx);
      ...
      `uvm_info("RC_PHY_MONITOR","ENTERED_INTO_TX_SIPO_RC_MONITOR", UVM_LOW)
          ...
          begin
           ...
           pcie_seq_item.data_q_rc_mon.push_back(tx_data);
          `uvm_info("RC_PHY_MONITOR",$sformatf("RC_TX_32_BIT_PARALLEL_MONITOR_DATA = %08h RC_MONITOR_QUEUE_SIZE=%d", tx_data,pcie_seq_item.data_q_rc_mon.size()),UVM_LOW);
